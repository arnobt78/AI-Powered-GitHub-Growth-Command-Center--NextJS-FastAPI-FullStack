...
| TBD | Phase 3 (visual/portfolio polish), Phase 4 sub-project 4G (the final one), and 4C/4D's deferred cross-posting/demo-asset-regen/Reddit scope once the relevant developer apps are registered |
