...
| TBD | Phase 3 (visual/portfolio polish), Phase 4 sub-projects 4F→4G, and 4C/4D's deferred cross-posting/demo-asset-regen/Reddit scope once the relevant developer apps are registered |
